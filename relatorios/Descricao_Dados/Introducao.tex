...
Cada arquivo CSV é composto de 61 colunas representando as 61 variáveis coletadas durante o teste. 
...
\begin{table}[h]
    ...
    \begin{tabular}{l|c|l}
        ...
        TORQUE\_REF\_LEFT\_MOTOR &  &  \\ 
        TORQUE\_REF\_RIGHT\_MOTOR & & \\
        ...
        LEFT\_MOTOR\_POWER &  & Potência medida no motor esquerdo pelo inversor \\
        ...
        RIGHT\_MOTOR\_POWER &  & Potência medida no motor direito pelo inversor \\
        RIGHT\_MOTOR\_CURRENT & A & Corrente em A medida no motor direito pelo inversor \\
        REAR\_LEFT\_WHEEL\_SPEED &  &  \\
        FRONT\_LEFT\_WHEEL\_SPEED &  &  \\
        REAR\_RIGHT\_WHEEL\_SPEED &  &  \\
        FRONT\_RIGHT\_WHEEL\_SPEED &  &  \\
