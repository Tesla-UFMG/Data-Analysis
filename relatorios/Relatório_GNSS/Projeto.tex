...
Devido aos componentes no bottom layer, o encapsulamento deve prever um ressalto de 5 mm 
nos 4 cantos onde são passados os parafusos (ou fitas-trava). 
...
A Figura \ref{fig:posicionamento} a localização da placa no chassi.
...
Dessa forma, o chicotes entram pelo canto esquerdo e a antena fica à direita na 
...
e sem considerar os custos que serão diluídos na compra em conjunto com outras placas.
